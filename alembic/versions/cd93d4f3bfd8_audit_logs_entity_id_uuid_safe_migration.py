...
Create Date: 2026-02-01 12:18:55.718912
...
def upgrade():
    ...
    # 2. (opcional) se quiser, pode copiar apenas onde fizer sentido
    # NÃO tente converter int -> uuid

    # 3. remove coluna antiga
    op.drop_column("audit_logs", "entity_id")

    # 4. renomeia para manter contrato
    op.alter_column("audit_logs", "entity_uuid", new_column_name="entity_id")
