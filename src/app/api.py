...
from app.modules.tax_rules.router import router as tax_rules_router
from app.modules.tax_calculations.router import router as tax_calculations_router
from app.modules.apurations.router import router as apurations_router
from app.modules.guides.router import router as guides_router
from app.modules.guides.pdf_router import router as guides_pdf_router
from app.modules.guides.router import router as guides_router
